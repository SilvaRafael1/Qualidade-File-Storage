        ...
        <div className='mt-6 bg-[#fff] w-full max-w-[1280px] shadow-xl'>
          {
            folders.map(folder => (
              <div key={folder._id}>
                <a href={folder._id} className='flex items-center border border-solid hover:bg-[#eee] p-5'>
          ...
          }
          {
            files.map(file => (
              <div key={file._id}>
                <a href={file.path} target='_blank' className='flex items-center border border-solid hover:bg-[#eee] p-5'>
